...
//   useEffect(() => {
//     console.log("Is a very nice", messages);
//   });
...
//   console.log("The user queries are=>", userQueries);
...
//   console.log("the ids are ", getAnchorId);
...
//       console.log("link", `#${getAnchorId(index)}` + " index", index);
//     });
//   }, [userQueries]);
        ...
        {visibleLinks.map((index) => (
          <div key={index} className="w-full">
            <Link
              ...
              onClick={(e) => {
                e.preventDefault();
                console.log(`Clicked on link for index: ${index}`);
                onLinkClick(index);
              }}
              className={cn(
                "text-[0.875rem] py-0 1/2 pl-3 border-l-2 border-gray-300 block hover:border-gray-500 hover:text-gray-900 transition-colors w-full",
